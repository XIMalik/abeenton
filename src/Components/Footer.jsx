...
const Footer = () => {
  ...
  <aside>
    <p className="footer_title mb-5 w-full">
      Tranquil Plains Estate
    </p>
  </aside>
  ...
  <nav>
    <div className="flex flex-row items-center justify-center gap-4">
      ...
      <a href="">
      <img width="34" height="34" src="https://img.icons8.com/sf-black-filled/64/whatsapp.png" alt="whatsapp"/>
      </a>
    </div>
  </nav>
